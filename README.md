...
- `GTK_IM_MODULE=wayland` so GTK4 apps trigger the OSK on focus. Persistent
...
### Install from Release Checkout
1. Clone GJS-OSK into a usable folder: `git clone https://github.com/Vishram1123/gjs-osk.git`
2. Symbolically link the extension folder to your user Extensions folder: `ln -s gjs-osk/gjsosk@vishram1123.com ~/.local/share/gnome-shell/extensions/`
3. Compile the schema in place `glib-compile-schemas gjsosk@vishram1123.com/schemas/`
## Usage
